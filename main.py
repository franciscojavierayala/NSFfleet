"""
main.py
Demo ejecutable del sistema cVAE Fleet.
...
def step_visualize(result, history, data_mode: str = "synthetic"):
    ...
    title = f"cVAE Fleet — Demo  [datos: {data_mode}]"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="cVAE Fleet — Demo")
    parser.add_argument(
    ...
    print(f"\n{'='*60}")
    print(f"  cVAE Fleet  —  modo: {CFG['data_mode'].upper()}")
    print(f"{'='*60}\n")
